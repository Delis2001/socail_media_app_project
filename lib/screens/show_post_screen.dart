  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:ListView.builder(
        ...
        return PostCard(authorprofilepic: posts[index]['author_profile_pic'].toString(), authorname: posts[index]['author_name'].toString(), content: posts[index]['content'].toString(), images: posts[index]['images'][0].toString());
      })
    );
  }
}
